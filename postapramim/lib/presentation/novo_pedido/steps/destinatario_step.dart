...
/// Etapa 2: identificação do destinatário e endereço de entrega.
/// Mesma estrutura da [RemetenteStep], com rótulos adaptados.
class DestinatarioStep extends StatefulWidget {
  const DestinatarioStep({
  ...
  final RascunhoDestinatario? dadosIniciais;

  @override
  State<DestinatarioStep> createState() => DestinatarioStepState();
}

class DestinatarioStepState extends State<DestinatarioStep> {
  ...
  bool confirmarEAvancar() {
    ...
    context.read<NovoPedidoController>().confirmarDestinatario(
          RascunhoDestinatario(
