...
/// Passo 1: Identificação e endereço de coleta do remetente.
class RemetenteStep extends StatefulWidget {
  const RemetenteStep({required this.data, super.key});

  final RemetenteStepData data;

  @override
  State<RemetenteStep> createState() => _RemetenteStepState();
}

class _RemetenteStepState extends State<RemetenteStep> {
  @override
...
/// Dados do step Remetente — passado por referência para que o
/// controller do formulário possa coletar os valores ao avançar.
class RemetenteStepData {
  RemetenteStepData();
