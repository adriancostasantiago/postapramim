...
/// "Speed lines" animadas de fundo da splash. Usa um único
/// `AnimationController` + `CustomPainter`, evitando rebuilds de widgets
/// — apenas repaint.
...
class _SpeedLinesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final spec in _curves) {
      ...
      canvas.drawPath(_dashedSegment(path, localProgress), paint);
    }
  }
